...
function AllSingleCard({d}) {
    const {imgURL,title,shortDescription,maxLoanLimit,interest,loanCategory,_id} = d
  return (
  ...
  <div className="card-body">
    ...
    <p className='font-semibold'>loanCategory: {loanCategory}</p>
    <p className='font-semibold'>interest: {interest}</p>
